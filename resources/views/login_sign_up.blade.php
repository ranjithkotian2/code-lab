...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://54.158.36.225:8000/login_sign_up">CODE LAB</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="http://54.158.36.225:8000/login">LOGIN</a></li>
                <li><a href="http://54.158.36.225:8000/sign_up">SIGN UP</a></li>
                <!-- <li class="dropdown">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="images/welcome3.jpeg" alt="New York" width="1200" height="700">
...
{{--            </div>--}}
        ...
        <div class="item">
            <img src="images/welcome1.jpeg" alt="Chicago" width="1200" height="700">
            <div class="carousel-caption">
                <h3>We show you the way </h3>
                <p>Perfect place to begin</p>
            </div>
        </div>
